...
Triton program.  It is default-off until real-checkpoint parity and FULL-graph
...
def _zaya_router_kernel(
    ...
    # Two scratch rows per token hold the intermediate router MLP.  The
    # barriers are required because both matvecs reuse the same storage.
